"""Tests for corpus/domain/rules.py's YAML profile loading/validation."""
import pytest
...
def isolated_profiles_dir(tmp_path, monkeypatch):
    ...
    profile files without touching the real corpus/domain/rules/."""
...
def test_real_criminal_procedure_act_profile_overrides_part_pattern():
    """The actual committed profile (corpus/domain/rules/criminal-procedure-act.yaml)
